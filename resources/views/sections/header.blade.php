                ...
                <div class="col-md-4 d-flex justify-content-center align-self-center">
                        <div class="news-letters">
                                <form id="newl" class="form-inline my-2 my-lg-0" action="{{route('news_letters')}}" method="POST">
                                        @csrf
                                                <input class="form-control transparent-input mr-sm-2"  type="email" name="email_nl" id="email_nl" placeholder="@NewsLetters" aria-label="Search" required>
                ...
                <div class="col-md-4 align-self-center">
                        ...
                        <div class="social text-right social_resp">
                                ...
                                <ul class="social-network social-circle">
                                    ...
                                    <li><a href="https://anoesistrio.bandcamp.com/" class="icoBandcamp" title="Bandcamp"><i class="fab fa-bandcamp"></i></a></li>
