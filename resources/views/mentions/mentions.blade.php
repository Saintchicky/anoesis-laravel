...
<div class="container" id="mentions">
        <button type="button" class="btn btn-outline-light btn-sm" data-toggle="modal" data-target="#exampleModalCenter">Mentions Legales</button>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Mentions Légales || anoesistrio.com</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p>Ce site est l'entière propriété du groupe de musique Anoesis Trio. Toute reproduction, même partielle, de ce site est strictement interdite.
                        <p><b>EDITEUR</b>
                        </br>
                        Ce site a été conçu et réalisé par Léopold MALTRET</br></p>
                        <p><b>HEBERGEMENT</b>
                        </br>
