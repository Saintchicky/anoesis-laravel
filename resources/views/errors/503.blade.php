...
<main class="block">
        ...
        <h1>Le site est sous maintenance</h1>
        <h2>On revient dès que possible !</h2>
        <h3>En attendant, tu peux nous joindre par email:</h3>
        <a href="mailto:anoesistrio@gmail.com" class="link">anoesistrio@gmail.com</a>
      </main>
</body>
